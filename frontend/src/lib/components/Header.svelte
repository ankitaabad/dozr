<script>
	import { customersStore, getInitials, isManager, customerId, stockPage } from '$lib/store';
...
>
	...
	<div class="flex items-center">
		{#if !$stockPage}
			<div
				class="flex items-center justify-center gap-2 pr-8 border-r border-gray-200 border-solid"
			>
				<div
